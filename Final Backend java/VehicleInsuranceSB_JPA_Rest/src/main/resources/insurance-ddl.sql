...
CREATE TABLE EMPLOYEE(
	...
	EMPLOYEE_FNAME varchar2(45) not null,
	EMPLOYEE_LNAME varchar2(45) not null,
	EMPLOYEE_USERNAME varchar2(45) not null,
	EMPLOYEE_PASSWORD varchar2(45) not null
);
...
NOMINEE_ID numeric(9) primary key,
CUST_ID NUMBER(9),
...
VEHICLE_ID NUMBER(9) primary key,
CUST_ID NUMBER(9),
VEHICLE_TYPE varchar2(20),
VEHICLE_REG_NUMBER varchar2(20),
VEHICLE_CHASIS_NUMBER varchar2(20),
VEHICLE_ENGINE_NUMBER varchar2(20),
VEHICLE_MANUFACTURER varchar2(20),
VEHICLE_MODEL_NUMBER varchar2(20),
...
DROP TABLE POLICY;
create table POLICY(
POLICY_NUMBER NUMBER(9) primary key,
