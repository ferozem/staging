...
public class LoginController {
	...
	public boolean empLogin(@RequestBody LoginDetails loginDetails) {
		return loginService.employeeLogin(loginDetails.getLoginUserName(),loginDetails.getLoginPassword());
	}
