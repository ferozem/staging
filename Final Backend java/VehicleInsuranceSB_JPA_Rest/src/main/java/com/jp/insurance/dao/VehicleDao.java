...
public interface VehicleDao {
	...
	public Vehicle findVehicleBydetails(Integer custId, String vehicleType,String vehicleRegNumber, String vehicleChasisNumber, String vehicleEngineNumber)throws VehicleException;//S-search
}
