...
public class Vehicle {
	...
	public Vehicle(Integer vehicleId, Integer custId, String vehicleType, String vehicleRegNumber,
			Integer vehicleChasisNumber, Integer vehicleEngineNumber, String vehicleManufacturer,
			Integer vehicleModelNumber, String vehicleMfgMMYYYY, Double vehicleIdvValue) {
		super();
	...
	public Integer getVehicleChasisNumber() {
		return vehicleChasisNumber;
	}

	public void setVehicleChasisNumber(Integer vehicleChasisNumber) {
		this.vehicleChasisNumber = vehicleChasisNumber;
	}

	public Integer getVehicleEngineNumber() {
		return vehicleEngineNumber;
	}

	public void setVehicleEngineNumber(Integer vehicleEngineNumber) {
		this.vehicleEngineNumber = vehicleEngineNumber;
	}
	...
	public Integer getVehicleModelNumber() {
		return vehicleModelNumber;
	}

	public void setVehicleModelNumber(Integer vehicleModelNumber) {
		this.vehicleModelNumber = vehicleModelNumber;
	}
