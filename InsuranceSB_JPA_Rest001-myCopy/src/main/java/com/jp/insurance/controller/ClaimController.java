...
public class ClaimController {
	...
	//http://localhost:8082/api/claim/getClaim/byCustId/{custId}	
	@GetMapping(path="/getClaim/byCustId/{custId}" ,produces="application/json")
	public List<Claim> getClaimByCustId(@PathVariable Integer custId) throws ClaimException{
		return claimService.getClaimListbyCustID(custId);
	}
}
