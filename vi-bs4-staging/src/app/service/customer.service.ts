...
export class CustomerService {
  ...
  baseUrl = "http://chandraspringbootdev.ap-south-1.elasticbeanstalk.com/api/customers";
  baseUrl2="http://chandraspringbootdev.ap-south-1.elasticbeanstalk.com/api/login/";
  ...
  getCustomerIdFromUserId() {
    ...
    return this.http.get<string>(this.baseUrl2+"getCustomerIdByUserId/"+id);
    
  }

  getCustomerIdByUserId(id:string) {
    console.log("inside getCustomerIdFromUserId method of customerService");
    // let id =localStorage.getItem('username');
    return this.http.get<string>(this.baseUrl2+"getCustomerIdByUserId/"+id);
