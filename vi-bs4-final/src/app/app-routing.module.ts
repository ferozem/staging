...
import { ListAllPoliciesComponent } from './components/list-all-policies/list-all-policies.component';
...
const routes: Routes = [
  ...
  {path:"existing-customer",component:ExistingCustomerComponent,canActivate:[AuthGuard]},
  ...
  {path:"listclaimbycustid",component:ClaimbycustIdComponent },
  {path:"list-policies",component:ListPolicyComponent },
  {path:"listticketsbycustid",component:TicketbycustIdComponent},
  {path:"list-all-policies",component:ListAllPoliciesComponent }
