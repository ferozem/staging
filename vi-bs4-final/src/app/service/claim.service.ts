...
export class ClaimService {
  ...
  baseUrl = "http://chandraspringbootdev.ap-south-1.elasticbeanstalk.com/api/claims";
  ...
  getClaimByCustId(id:string){

    return this.http.get<Claim[]>(this.baseUrl+"/getClaim/byCustId/"+id);
